pub(crate) fn are_all_increasing(report: &Vec<i32>) -> bool {
...
pub(crate) fn are_all_decreasing(report: &Vec<i32>) -> bool {
    let mut last_level: &i32 = report.get(0).unwrap();
    for level in report {
...
pub(crate) fn are_all_changing_in_defined_range(report: &Vec<i32>, lower_bound: i32, upper_bound:i32) -> bool {
    let mut last_level: &i32 = report.get(0).unwrap();
